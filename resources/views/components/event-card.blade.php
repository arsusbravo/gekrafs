...
<a href="{{ route('events.show', $event) }}" class="group flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 transition hover:-translate-y-1 hover:shadow-xl hover:ring-brand-200">
    <div class="relative">
        @if ($event->image_url)
